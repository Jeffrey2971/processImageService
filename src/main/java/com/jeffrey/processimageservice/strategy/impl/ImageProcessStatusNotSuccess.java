 ...
 * @since JDK 1.8
 */
public class ImageProcessStatusNotSuccess implements ShoutNotUpdateCountsStrategy {

    @Override
    public boolean showNotUpdateCounts(GenericResponse genericResponse) {

        return !(genericResponse.getData().getProcessStatus() == ResponseStatus.SC_PROCESS_SUCCESS.getValue());
    }
}
